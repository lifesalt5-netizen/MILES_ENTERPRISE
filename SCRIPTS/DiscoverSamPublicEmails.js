...
if(require.main===module)main().catch(e=>{console.error(JSON.stringify({ok:false,service:'SAM_PUBLIC_EMAIL_DISCOVERY',error:e.message},null,2));process.exitCode=2;});
