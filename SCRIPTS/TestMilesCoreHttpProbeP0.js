...
const checks = [
  ...
  { name: "CEO product launchpad", port: 8737, path: "/", expect: value => /P2GC Product Launchpad/i.test(value.text) && /Open Full Prospect Blueprint/i.test(value.text) && /Open Sub2Prime/i.test(value.text) && /Opportunity Intelligence/i.test(value.text) && /Vehicle Intelligence/i.test(value.text) && /Recompete Intelligence/i.test(value.text) && /127\.0\.0\.1:8791\/teaming/i.test(value.text) },
