...
try{
  ...
  const ready=svc.buildDraft(r.reviewId,{packageName:'Federal Pathway Validation',scopeSummary:'Validate the recommended federal growth pathway.',price:2500,currency:'USD',proposalRef:'PROP-001',paymentUrl:'https://pay.example.com/p2gc-test',approvedByKevin:true,approvalNote:'Approved for test'});
