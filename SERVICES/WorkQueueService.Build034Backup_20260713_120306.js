...
class WorkQueueService {
    ...
    createWorkItem(input) {
        ...
        console.log("[BUILD034] Signature:", signature);
console.log("[BUILD034] Input:", {
    area: input.area,
    provider: input.relatedProvider,
    capability: input.capability,
    metadataCapability: input.metadata?.capability,
    title: input.title,
    ...
    const provider =
        normalize(input.relatedProvider);
